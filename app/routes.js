SteedOfficeApp.config(function($stateProvider, $urlRouterProvider) {
    ...
    .state('access.login', {
                ...
                deps: ['$ocLazyLoad',
                    function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            name: 'SteedOfficeApp.Auth',
                            insertBefore: '#ng_load_plugins_before',
                            files: [
                                'assets/admin/pages/css/login2.css',
                                'modules/auth/auth.ctrl.js',
                                'modules/auth/auth.srv.js',
        ...
        .state('app.user.all', {
            url: '/all',
            controller:'UserCtrl',
            templateUrl: 'modules/user/all-user.view.html',
        })
        .state('app.user.add', {
            url: '/add',
            controller:'UserCtrl',
            templateUrl: 'modules/user/add-user.view.html',
        })
    // AngularJS plugins
    .state('app.upload_demo', {
        url: "/upload-demo",
        templateUrl: "modules/upload-demo/demo.view.html",
        data: {
        ...
        resolve: {
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load([{
                    ...
                    name: 'SteedOfficeApp.UploadDemo',
                    files: [
                        'modules/upload-demo/upload-demo.ctrl.js'
                    ]
                }]);
            }]
        }
