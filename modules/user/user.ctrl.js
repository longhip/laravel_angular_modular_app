angular.module('SteedOfficeApp.User').controller('UserCtrl', function($rootScope,$http,$state, $scope, $timeout,$translate,$translatePartialLoader,UserService,ToastFactory) {
